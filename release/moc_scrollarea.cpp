...
QT_MOC_LITERAL(1, 11, 14), // "drawRectSignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 8) // "cv::Rect"

    },
    "ScrollArea\0drawRectSignal\0\0cv::Rect"
};
...
void ScrollArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->drawRectSignal((*reinterpret_cast< cv::Rect(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ScrollArea::*_t)(cv::Rect );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScrollArea::drawRectSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ScrollArea::drawRectSignal(cv::Rect _t1)
{
